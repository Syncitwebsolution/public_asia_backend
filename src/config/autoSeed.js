...
const articlesData = {
  ...
  "क्रिकेट": [
    ...
    },
    {
      ...
      content: "<p>भारतीय महिला क्रिकेट टीम ने शानदार प्रदर्शन करते हुए T20 विश्व कप के final में इंग्लैंड को 7 विकेट से हराकर खिताब अपने नाम किया। कप्तान हरमनप्रीत कौर ने नाबाद 78 रन की शानदार पारी खेली।</p>",
...
export async function autoSeed() {
  try {
    ...
    if (admin) {
      console.log('👤 Admin user already exists. Ensuring correct settings.');
      admin.role = 'ADMIN';
    ...
    // 2. Check if we need to seed categories/articles/videos
    const catCount = await Category.countDocuments();
    if (catCount > 0) {
      console.log('📚 Database already contains data. Skipping default categories/articles seeding.');
      return;
    }
